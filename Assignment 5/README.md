...
- Write pseudocode before coding to demonstrate your understanding of interactive programming theory and focus on the logic without being distracted by details of syntax
...
You should start by using the [starter code](starter_code/) and focus on adding the proper JavaScript to update the background of the page. Please create a new repository on GitHub called "homework-city" and push your code to it when they are ready to submit. 
